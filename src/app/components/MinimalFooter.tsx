      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-8 lg:px-16 py-16">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mt-6 text-[15px] text-[rgba(240,242,245,0.5)] leading-[1.6] max-w-[280px]">
          ...
          {/* Services Column */}
          <div>
            <h3 className="font-mono text-xs tracking-[2px] uppercase text-[rgba(240,242,245,0.4)] mb-5">Services</h3>
            <ul className="space-y-2.5 text-[14px]">
              <li><a href="#" onClick={(e) => handleServiceClick(e, "emergency-support")} className="text-[rgba(240,242,245,0.6)] hover:text-[#F0F2F5] transition-colors">Emergency Support</a></li>
              <li><a href="#" onClick={(e) => handleServiceClick(e, "service-contract")} className="text-[rgba(240,242,245,0.6)] hover:text-[#F0F2F5] transition-colors">Service Contracts</a></li>
              <li><a href="#" onClick={(e) => handleServiceClick(e, "field-service")} className="text-[rgba(240,242,245,0.6)] hover:text-[#F0F2F5] transition-colors">Field Service</a></li>
              <li><a href="#" onClick={(e) => handleServiceClick(e, "food-safety")} className="text-[rgba(240,242,245,0.6)] hover:text-[#F0F2F5] transition-colors">Food Safety</a></li>
              <li><a href="#" onClick={(e) => handleServiceClick(e, "legacy-upgrade")} className="text-[rgba(240,242,245,0.6)] hover:text-[#F0F2F5] transition-colors">Legacy Upgrade</a></li>
              <li><a href="#" onClick={(e) => handleServiceClick(e, "automation-advantage")} className="text-[rgba(240,242,245,0.6)] hover:text-[#F0F2F5] transition-colors">Automation Advantage</a></li>
              <li><a href="#" onClick={(e) => handleServiceClick(e, "engineering")} className="text-[rgba(240,242,245,0.6)] hover:text-[#F0F2F5] transition-colors">Engineering</a></li>
              <li><a href="#" onClick={(e) => handleServiceClick(e, "easy-products")} className="text-[rgba(240,242,245,0.6)] hover:text-[#F0F2F5] transition-colors">Easy Products</a></li>
            </ul>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-[rgba(240,242,245,0.08)] flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 text-[13px] text-[rgba(240,242,245,0.35)]">
          <p>&copy; {currentYear} Liquid Consulting Inc. All rights reserved.</p>
          <div>
            <a href="#" onClick={handleTermsClick} className="hover:text-[#F0F2F5] transition-colors">Terms & Policy</a>
          </div>
        </div>
      </div>
      ...
      {showTermsModal && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" onClick={() => setShowTermsModal(false)}>
          <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-hidden" onClick={(e) => e.stopPropagation()}>
            {/* Modal Header */}
            <div className="sticky top-0 bg-white border-b border-[#E0E4EA] px-6 py-4 flex justify-between items-center">
              <h2 className="text-2xl font-bold text-[#0A1628]">Terms & Policy</h2>
              <button
                onClick={() => setShowTermsModal(false)}
                className="p-2 hover:bg-[#F0F2F5] rounded-full transition-colors"
                aria-label="Close"
              >
                <X className="w-6 h-6 text-[#6B7A8D]" />
              </button>
            </div>
            ...
            <div className="px-6 py-6 overflow-y-auto max-h-[calc(90vh-80px)]">
              <div className="prose prose-sm max-w-none">
                <h3 className="text-xl font-bold text-[#0A1628] mb-4">Liquid General Terms and Conditions</h3>
                ...
                <h4 className="text-lg font-bold text-[#0A1628] mt-6 mb-3">1. General Description and Scope of Service</h4>
                <p className="text-[#4B5563] mb-4">
                ...
                <h4 className="text-lg font-bold text-[#0A1628] mt-6 mb-3">2. Independent Contractor</h4>
                <p className="text-[#4B5563] mb-4">
                ...
                <h4 className="text-lg font-bold text-[#0A1628] mt-6 mb-3">3. Customer Representative</h4>
                <p className="text-[#4B5563] mb-4">
                ...
                <h4 className="text-lg font-bold text-[#0A1628] mt-6 mb-3">4. Work Product</h4>
                <p className="text-[#4B5563] mb-4">
                ...
                <h4 className="text-lg font-bold text-[#0A1628] mt-6 mb-3">5. Warranty</h4>
                <p className="text-[#4B5563] mb-4">
                ...
                <h4 className="text-lg font-bold text-[#0A1628] mt-6 mb-3">6. Indemnification</h4>
                <p className="text-[#4B5563] mb-4">
                ...
                <h4 className="text-lg font-bold text-[#0A1628] mt-6 mb-3">7. Confidential Information</h4>
                <p className="text-[#4B5563] mb-4">
                ...
                <h4 className="text-lg font-bold text-[#0A1628] mt-6 mb-3">9. Site Conditions</h4>
                <p className="text-[#4B5563] mb-4">
                ...
                <h4 className="text-lg font-bold text-[#0A1628] mt-6 mb-3">10. Taxes</h4>
                <p className="text-[#4B5563] mb-4">
                ...
                <h4 className="text-lg font-bold text-[#0A1628] mt-6 mb-3">11. Payment Terms</h4>
                <p className="text-[#4B5563] mb-4">
                ...
                <h4 className="text-lg font-bold text-[#0A1628] mt-6 mb-3">12. Waiver of Certain Damages</h4>
                <p className="text-[#4B5563] mb-4">
                ...
                <h4 className="text-lg font-bold text-[#0A1628] mt-6 mb-3">13. Waiver of Jury Trial</h4>
                <p className="text-[#4B5563] mb-4">
                ...
                <h4 className="text-lg font-bold text-[#0A1628] mt-6 mb-3">14. Excusable Delay</h4>
                <p className="text-[#4B5563] mb-4">
                ...
                <h4 className="text-lg font-bold text-[#0A1628] mt-6 mb-3">15. Non-Solicitation</h4>
                <p className="text-[#4B5563] mb-4">
                  During the time in which Liquid Consulting is providing services to Customer and for a period of two (2) years thereafter, Customer shall not directly or indirectly, in any capacity, interfere with, solicit, hire or entice away any employee or independent contractor, or former employee or independent contractor of the Liquid Consulting (i.e., any person who, at the time of such solicitation or hiring, had been an employee or independent contractor of Liquid Consulting within the past twelve (12) months from the date of determination).
                </p>

                <h4 className="text-lg font-bold text-[#0A1628] mt-6 mb-3">16. Miscellaneous</h4>
                <p className="text-[#4B5563] mb-4">
                  <strong>16.1.</strong> These Terms shall be binding upon the parties' respective successor and permitted assigns. Neither party may assign these Terms, and/or any of its rights and obligations hereunder except to a successor entity through merger or consolidation, without the prior written consent of the other party, such consent not to be unreasonably withheld.
                </p>
                <p className="text-[#4B5563] mb-4">
                  <strong>16.2.</strong> The validity of these Terms, the construction of the terms, and the interpretation of the rights and duties of the parties shall be governed by the laws of the State of Florida, without giving effect to its conflict of law principles. The parties agree that the courts situated within or having jurisdiction over Seminole County, Florida, shall be the exclusive courts of jurisdiction and venue for any litigation.
                </p>
                <p className="text-[#4B5563] mb-4">
                  <strong>16.3.</strong> No modification, amendment, supplement to or waiver of these Terms or any of its provisions shall be binding upon the parties hereto unless made in writing and duly signed by both parties.
                </p>
                <p className="text-[#4B5563] mb-4">
                  <strong>16.4.</strong> A failure or delay of either party to these Terms to enforce at any time any of the provisions of these Terms, or to exercise any option which is herein provided, or to require at any time performance of any of the provisions hereof, shall in no way be construed to be a waiver of such provision of these Terms.
                </p>
                <p className="text-[#4B5563] mb-4">
                  <strong>16.5.</strong> In the event any one or more of the Terms shall for any reason be held to be invalid, illegal or unenforceable, the remaining provisions of these Terms shall be unimpaired, and the invalid, illegal or unenforceable provision shall be replaced by a mutually acceptable provision.
                </p>
                <p className="text-[#4B5563] mb-4">
                  <strong>16.6.</strong> The terms and conditions of any and all Work Orders and any other attachment(s) to these Terms are incorporated herein by this reference and shall constitute part of these Terms as if fully set forth herein. These Terms, together with so incorporated attachments, constitutes the entire agreement between the parties and supersedes all previous agreements, promises, representations, whether written or oral.
                </p>
                <p className="text-[#4B5563] mb-4">
                  <strong>16.7.</strong> In the event of any litigation between the parties arising out of or relating to Services, Equipment, Works, or any Work Order, the prevailing party shall be entitled to recover from the non prevailing party all costs and reasonable attorneys' fees incurred.
                </p>

                <h4 className="text-lg font-bold text-[#0A1628] mt-6 mb-3">Contact Information</h4>
