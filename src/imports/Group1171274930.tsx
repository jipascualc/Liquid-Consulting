...
function Link() {
  return (
    <div className="-translate-y-1/2 absolute h-[70px] left-0 top-1/2 w-[188.16px]" data-name="Link">
      <Group />
    </div>
  );
}
